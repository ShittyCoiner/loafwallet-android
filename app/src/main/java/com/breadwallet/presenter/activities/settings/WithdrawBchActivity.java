...
public class WithdrawBchActivity extends BRActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String balance = BRCurrency.getFormattedCurrencyString(this, BRSharedPrefs.getPreferredBTC(this) ? "SYC" : BRSharedPrefs.getIso(this), new BigDecimal(BRWalletManager.getBCashBalance(BRKeyStore.getMasterPublicKey(app))));
